...
public class JPF_java_lang_Character extends NativePeer {
  ...
  public void $clinit____V (MJIEnv env, int clsObjRef) {
    ...
    env.setStaticByteField(ctx, "java.lang.Character", "UNASSIGNED", (byte) 0);
    env.setStaticByteField(ctx, "java.lang.Character", "UPPERCASE_LETTER", (byte) 1);
    env.setStaticByteField(ctx, "java.lang.Character", "LOWERCASE_LETTER", (byte) 2);
    env.setStaticByteField(ctx, "java.lang.Character", "TITLECASE_LETTER", (byte) 3);
    env.setStaticByteField(ctx, "java.lang.Character", "MODIFIER_LETTER", (byte) 4);
    env.setStaticByteField(ctx, "java.lang.Character", "OTHER_LETTER", (byte) 5);
    env.setStaticByteField(ctx, "java.lang.Character", "NON_SPACING_MARK", (byte) 6);
    env.setStaticByteField(ctx, "java.lang.Character", "ENCLOSING_MARK", (byte) 7);
    env.setStaticByteField(ctx, "java.lang.Character", "COMBINING_SPACING_MARK", (byte) 8);
    env.setStaticByteField(ctx, "java.lang.Character", "DECIMAL_DIGIT_NUMBER", (byte) 9);
    env.setStaticByteField(ctx, "java.lang.Character", "LETTER_NUMBER", (byte) 10);
    env.setStaticByteField(ctx, "java.lang.Character", "OTHER_NUMBER", (byte) 11);
    env.setStaticByteField(ctx, "java.lang.Character", "SPACE_SEPARATOR", (byte) 12);
    env.setStaticByteField(ctx, "java.lang.Character", "LINE_SEPARATOR", (byte) 13);
    env.setStaticByteField(ctx, "java.lang.Character", "PARAGRAPH_SEPARATOR", (byte) 14);
    env.setStaticByteField(ctx, "java.lang.Character", "CONTROL", (byte) 15);
    env.setStaticByteField(ctx, "java.lang.Character", "FORMAT", (byte) 16);
    env.setStaticByteField(ctx, "java.lang.Character", "PRIVATE_USE", (byte) 18);
    env.setStaticByteField(ctx, "java.lang.Character", "SURROGATE", (byte) 19);
    env.setStaticByteField(ctx, "java.lang.Character", "DASH_PUNCTUATION", (byte) 20);
    env.setStaticByteField(ctx, "java.lang.Character", "START_PUNCTUATION", (byte) 21);
    env.setStaticByteField(ctx, "java.lang.Character", "END_PUNCTUATION", (byte) 22);
    env.setStaticByteField(ctx, "java.lang.Character", "CONNECTOR_PUNCTUATION", (byte) 23);
    env.setStaticByteField(ctx, "java.lang.Character", "OTHER_PUNCTUATION", (byte) 24);
    env.setStaticByteField(ctx, "java.lang.Character", "MATH_SYMBOL", (byte) 25);
