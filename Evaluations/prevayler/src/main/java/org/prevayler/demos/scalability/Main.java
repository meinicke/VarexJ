...
public class Main {
	...
	static private void createPropertiesFile(File file) throws IOException {
		...
		stream.println(
			...
			"PrevaylerQueryThreadsMaximum = 1\n" +
			...
			"PrevaylerTransactionThreadsMaximum = 1\n" +
			"#\n" +
			...
			"JdbcTransactionThreadsMaximum = 1\n" +
			"# More threads can produce better results on some machines.\n" +
			"\n" +
			"\n" +
			"###########################################################\n" +
	...
	static private int numberOfObjects() {
		...
		if ("TEN".equals(property)) return   10;
