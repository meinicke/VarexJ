...
public class RandomGeneratorFactoryTest extends TestJPF {
    ...
    public void testNextIntDirect() throws Exception {
        if (verifyNoPropertyViolation(config)) {
               org.apache.commons.math3.random.RandomGeneratorFactoryTest object = new org.apache.commons.math3.random.RandomGeneratorFactoryTest();
               object.setUp();
