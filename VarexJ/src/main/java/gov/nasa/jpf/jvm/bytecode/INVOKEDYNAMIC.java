 ...
 * ..., [arg1, [arg2 ...]]  => ...
 */
public class INVOKEDYNAMIC extends JVMInstruction {
  ...
  public Conditional<Instruction> execute(FeatureExpr ctx, ThreadInfo ti) {
    ...
    if(ei==null || ei!=lastFuncObj || freeVariableTypes.length>0) {
      ...
      if (fiClassInfo.initializeClass(ctx, ti)) {
        return ti.getPC();
      }
    ...
    frame.pop(ctx, freeVariableTypes.length);
    frame.pushRef(ctx, funcObjRef);
