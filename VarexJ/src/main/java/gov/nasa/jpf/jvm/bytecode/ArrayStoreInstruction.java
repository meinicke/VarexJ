...
public abstract class ArrayStoreInstruction extends ArrayElementInstruction implements StoreInstruction {
	...
	protected abstract void setField(FeatureExpr ctx, ElementInfo e, int index, StackFrame frame) throws ArrayIndexOutOfBoundsExecutiveException;
