 ...
 */
public class TestMiranda extends TestJPF {
	...
	/**
	 * An abstract class implementing the interface, as it's abstract it doesn't
	 * need to implement the method thereby creating the abstract Miranda method
	 * (in this case called someMethod) that all sub-classes must implement
	 */
	...
	/**
	 * A genuine implementation of AbstractClass that must implement someMethod
	 ...
	 * 
	 * @param test
	 *            of type AbstractClass, therefore must have implementation of
	 *            Interface
	 */
	// @NoInline
	private static void testSomeClass(AbstractClass test) {
		int result = test.someMethod(6, 7);
		System.out.println("AbstractClass.someMethod(6,7) Expected: 42 Actual: " + result);
