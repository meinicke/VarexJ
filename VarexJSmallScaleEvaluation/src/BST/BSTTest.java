...
public class BSTTest {
	...
	public static void main(String[] args) {
		...
		final int N = 7;
		for (int i = 0; i < N; i++) {
			boolean add = Verify.getBoolean();//new Choice().add;
...
/**
 *
 * @author Mithun Acharya Taken from Tao Xie's CSC 591t class In fact, this is
 *         same as issta2006.BinTree.BinTree.java
 */
class BST {
	private Node root;
