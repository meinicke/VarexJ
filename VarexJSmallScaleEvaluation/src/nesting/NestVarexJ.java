...
public class NestVarexJ {

	public static void main(String[] args) {
		Verify.resetInstructionCounter();
		new NestVarexJ(Integer.parseInt(args[0]));
	}
	...
	public NestVarexJ(int max) {
		int i = 0;

		int current = 0;
		if (current++ == max) return;
		if (a1 ) {i++;if(1  == max) return;
		if (a2 ) {i++;if(2  == max) return;
		if (a3 ) {i++;if(3  == max) return;
		if (a4 ) {i++;if(4  == max) return;
		if (a5 ) {i++;if(5  == max) return;
		if (a6 ) {i++;if(6  == max) return;
		if (a7 ) {i++;if(7  == max) return;
		if (a8 ) {i++;if(8  == max) return;
		if (a9 ) {i++;if(9  == max) return;
		if (a10){i++;if (10 == max) return;
		if (a11){i++;if (11 == max) return;
		if (a12){i++;if (12 == max) return;
		if (a13){i++;if (13 == max) return;
		if (a14){i++;if (14 == max) return;
		if (a15){i++;if (15 == max) return;
		if (a16){i++;if (16 == max) return;
		if (a17){i++;if (17 == max) return;
		if (a18){i++;if (18 == max) return;
		if (a19){i++;if (19 == max) return;
		if (a20){i++;if (20 == max) return;
		if (a21){i++;if (21 == max) return;
		if (a22){i++;if (22 == max) return;
		if (a23){i++;if (23 == max) return;
		if (a24){i++;if (24 == max) return;
		if (a25){i++;if (25 == max) return;
		if (a26){i++;if (26 == max) return;
		if (a27){i++;if (27 == max) return;
		if (a28){i++;if (28 == max) return;
		if (a29){i++;if (29 == max) return;
		if (a30){i++;if (30 == max) return;
		if (a31){i++;if (31 == max) return;
		if (a32){i++;if (32 == max) return;
		if (a33){i++;if (33 == max) return;
		if (a34){i++;if (34 == max) return;
		if (a35){i++;if (35 == max) return;
		if (a36){i++;if (36 == max) return;
		if (a37){i++;if (37 == max) return;
		if (a38){i++;if (38 == max) return;
		if (a39){i++;if (39 == max) return;
		if (a40){i++;if (40 == max) return;
		if (a41){i++;if (41 == max) return;
		if (a42){i++;if (42 == max) return;
		if (a43){i++;if (43 == max) return;
		if (a44){i++;if (44 == max) return;
		if (a45){i++;if (45 == max) return;
		if (a46){i++;if (46 == max) return;
		if (a47){i++;if (47 == max) return;
		if (a48){i++;if (48 == max) return;
		if (a49){i++;if (49 == max) return;
		if (a50){i++;if (50 == max) return;
		if (a51){i++;if (51 == max) return;
		if (a52){i++;if (52 == max) return;
		if (a53){i++;if (53 == max) return;
		if (a54){i++;if (54 == max) return;
		if (a55){i++;if (55 == max) return;
		if (a56){i++;if (56 == max) return;
		if (a57){i++;if (57 == max) return;
		if (a58){i++;if (58 == max) return;
		if (a59){i++;if (59 == max) return;
		if (a60){i++;if (60 == max) return;
		if (a61){i++;if (61 == max) return;
		if (a62){i++;if (62 == max) return;
		if (a63){i++;if (63 == max) return;
		if (a64){i++;if (64 == max) return;
		if (a65){i++;if (65 == max) return;
		if (a66){i++;if (66 == max) return;
		if (a67){i++;if (67 == max) return;
		if (a68){i++;if (68 == max) return;
		if (a69){i++;if (69 == max) return;
		if (a70){i++;if (70 == max) return;
		if (a71){i++;if (71 == max) return;
		if (a72){i++;if (72 == max) return;
		if (a73){i++;if (73 == max) return;
		if (a74){i++;if (74 == max) return;
		if (a75){i++;if (75 == max) return;
		if (a76){i++;if (76 == max) return;
		if (a77){i++;if (77 == max) return;
		if (a78){i++;if (78 == max) return;
		if (a79){i++;if (79 == max) return;
		if (a80){i++;if (80 == max) return;
		if (a81){i++;if (81 == max) return;
		if (a82){i++;if (82 == max) return;
		if (a83){i++;if (83 == max) return;
		if (a84){i++;if (84 == max) return;
		if (a85){i++;if (85 == max) return;
		if (a86){i++;if (86 == max) return;
		if (a87){i++;if (87 == max) return;
		if (a88){i++;if (88 == max) return;
		if (a89){i++;if (89 == max) return;
		if (a90){i++;if (90 == max) return;
		if (a91){i++;if (91 == max) return;
		if (a92){i++;if (92 == max) return;
		if (a93){i++;if (93 == max) return;
		if (a94){i++;if (94 == max) return;
		if (a95){i++;if (95 == max) return;
		if (a96){i++;if (96 == max) return;
		if (a97){i++;if (97 == max) return;
		if (a98){i++;if (98 == max) return;
		if (a99){i++;if (99 == max) return;
		if (a100){i++;if(100== max) return;
