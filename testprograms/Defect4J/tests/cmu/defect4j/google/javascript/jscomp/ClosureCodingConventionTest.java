...
public class ClosureCodingConventionTest extends TestJPF {
	...
	public void testVarAndOptionalParams() throws Exception {
		if (verifyNoPropertyViolation(config)) {
			TestCase testcase = new com.google.javascript.jscomp.ClosureCodingConventionTest() {
	...
	@Test(timeout=120000)
	public void testInheritanceDetection11() throws Exception {
		if (verifyNoPropertyViolation(config)) {
			TestCase testcase = new com.google.javascript.jscomp.ClosureCodingConventionTest() {
				public void runTest() throws Exception {
					testInheritanceDetection11();
				}
			};
			testcase.run();
		}
	...
	@Test(timeout=120000)
	public void testInheritanceDetection12() throws Exception {
		if (verifyNoPropertyViolation(config)) {
			TestCase testcase = new com.google.javascript.jscomp.ClosureCodingConventionTest() {
				public void runTest() throws Exception {
					testInheritanceDetection12();
				}
			};
			testcase.run();
		}
	...
	@Test(timeout=120000)
	public void testInheritanceDetection13() throws Exception {
		if (verifyNoPropertyViolation(config)) {
			TestCase testcase = new com.google.javascript.jscomp.ClosureCodingConventionTest() {
				public void runTest() throws Exception {
					testInheritanceDetection13();
				}
			};
			testcase.run();
		}
	...
	@Test(timeout=120000)
	public void testInheritanceDetection14() throws Exception {
		if (verifyNoPropertyViolation(config)) {
			TestCase testcase = new com.google.javascript.jscomp.ClosureCodingConventionTest() {
				public void runTest() throws Exception {
					testInheritanceDetection14();
				}
			};
			testcase.run();
		}
